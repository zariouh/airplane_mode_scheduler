...
class NotificationService {
  ...
  Future<void> init() async {
    try {
      ...
      // ✅ FIXED: Use positional parameter (not named 'settings:')
  ...
  Future<void> showAirplaneModeNotification({
    ...
    try {
      ...
      // ✅ FIXED: Use existing launcher icon instead of non-existent drawables
      final AndroidNotificationDetails androidDetails = 
        ...
        showWhen: true,
        icon: '@mipmap/ic_launcher',  // Use existing icon
      ...
      // ✅ FIXED: Use positional parameters
